...
io.on('connection', (socket) => {
  ...
  socket.on('join', (options, callback) => {
    ...
    //io.to.emit --emits an event in a specific room not another room
    //socket.to.broadcast.emit -- sends to everyone exept for the spesific cilent, limiting a specific chat room
